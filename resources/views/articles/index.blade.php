...
<h1 id="pageTitle" class="fw-bold text-center">Article Page</h1>
<div
    id="table-container"
...
>
    <table class="table mx-auto">
        ...
        <tr>
            ...
            <th scope="col" class="table-title">Penyelenggara Seminar Konferensi Simposium</th>
            <th scope="col" class="table-title">Waktu Pelaksanaan Seminar Konferensi Simposium</th>
            <th scope="col" class="table-title">ISBN_ISSN</th>
        </tr>
        </thead>
        <tbody>
